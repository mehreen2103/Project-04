...
/**
 * CourseCtl Controller.
 * Handles Add, Update, Reset, Cancel operations for Course.
 * 
 * @author mehre
 */
...
public class CourseCtl extends BaseCtl {
    ...
    /**
     * Loads Course data when id is present, otherwise opens blank form.
     * 
     * @param request HttpServletRequest
    ...
    /**
     * Handles form submission for Save, Update, Reset, Cancel operations.
     * 
     * @param request HttpServletRequest
     * @param response HttpServletResponse
     */
